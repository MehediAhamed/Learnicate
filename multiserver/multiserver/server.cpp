...
int main()
{
	...
	std::thread  ts1(video,18002,18003),ts2(video,18004, 18001), ts3(audio,16602, 16603), ts4(audio,16604, 16601),ts5(chat,6602,6603), ts6(chat, 6604, 6601);
